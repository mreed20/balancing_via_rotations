...
and rotates the edges of $S$ until $S$ equals $T$.
...
closer to the actual number more consistently. This may be due to a bug I failed to find.
...
equivalent subtrees, which should lead to $A_2$ and $A_3$ performing the same number of
rotations.

For each pairing of algorithm and value of $n$ ($n=1000$, $1100$, and $1200$),
the driver/main program performs 5 experiments.
Here is the output of the driver program:
